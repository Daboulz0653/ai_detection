...
for domain in test_df["domain"].unique():
    ...
    for i in range(100):
        ...
        size = round(200/len(domain_models))
        ...
        file_path = f"{test_dataset}/HDSR_train/bygenre_1000/{test_dataset}_{domain}_random_forest_final.csv"
        ...
        run_info_df.to_csv(f'{test_dataset}/{test_dataset}_bygenre_1000_classifier_log.csv', mode='a', index=False, header=False)
